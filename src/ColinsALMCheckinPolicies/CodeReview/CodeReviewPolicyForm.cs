...
namespace ColinsALMCheckinPolicies
{
    public partial class CodeReviewPolicyForm : Form
    {
        ...
        private void cmbPassLevel_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void chkRequireClose_CheckedChanged(object sender, EventArgs e)
        {
            Config.RequireReviewToBeClosed = chkRequireClose.Checked;
        }

        private void chkFailAnyBad_CheckedChanged(object sender, EventArgs e)
        {
            Config.FailIfAnyResponseIsNeedsWork = chkFailAnyBad.Checked;
        }

        private void chkOnlyMostRecent_CheckedChanged(object sender, EventArgs e)
        {
